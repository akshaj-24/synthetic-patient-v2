const sectionFields = {
    ...
    cbt: [
        ...
        { id: 'intermediate_belief', deps: ['age', 'gender', 'name', 'ethnicity', 'marital_status', 'children', 'grandchildren', 'education', 'occupation', 'disorder', 'type', 'base_emotions', 'helpless_beliefs', 'unlovable_beliefs', 'worthless_beliefs'] },
        { id: 'trigger',             deps: ['age', 'gender', 'name', 'ethnicity', 'marital_status', 'children', 'grandchildren', 'education', 'occupation', 'disorder', 'type', 'base_emotions', 'helpless_beliefs', 'unlovable_beliefs', 'worthless_beliefs', 'intermediate_belief'] }, 
        { id: 'auto_thoughts',       deps: ['age', 'gender', 'name', 'ethnicity', 'marital_status', 'children', 'grandchildren', 'education', 'occupation', 'disorder', 'type', 'base_emotions', 'helpless_beliefs', 'unlovable_beliefs', 'worthless_beliefs', 'intermediate_belief', 'trigger'] },
        { id: 'coping_strategies',   deps: ['age', 'gender', 'name', 'ethnicity', 'marital_status', 'children', 'grandchildren', 'education', 'occupation', 'disorder', 'type', 'base_emotions', 'helpless_beliefs', 'unlovable_beliefs', 'worthless_beliefs', 'intermediate_belief', 'trigger', 'auto_thoughts'] },
        { id: 'behavior',            deps: ['age', 'gender', 'name', 'ethnicity', 'marital_status', 'children', 'grandchildren', 'education', 'occupation', 'disorder', 'type', 'base_emotions', 'helpless_beliefs', 'unlovable_beliefs', 'worthless_beliefs', 'intermediate_belief', 'trigger', 'auto_thoughts', 'coping_strategies'] },
        { id: 'impact',              deps: ['age', 'gender', 'name', 'ethnicity', 'marital_status', 'children', 'grandchildren', 'education', 'occupation', 'disorder', 'type', 'base_emotions', 'helpless_beliefs', 'unlovable_beliefs', 'worthless_beliefs', 'intermediate_belief', 'trigger', 'auto_thoughts', 'coping_strategies', 'behavior'] },
        { id: 'intake',              deps: ['age', 'gender', 'name', 'ethnicity', 'marital_status', 'children', 'grandchildren', 'education', 'occupation', 'disorder', 'type', 'base_emotions', 'helpless_beliefs', 'unlovable_beliefs', 'worthless_beliefs', 'intermediate_belief', 'trigger', 'auto_thoughts', 'coping_strategies', 'behavior', 'impact'] },
...
function setLoading(el, loading) {
    if (loading) {
        ...
        if (!el.dataset.locked) el.disabled = false;
    }
}
